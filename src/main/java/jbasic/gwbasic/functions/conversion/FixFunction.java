...
/**
 * Fix Function
 * <br>Purpose: To truncate x to a whole number
 * @author lawrence.daniels@gmail.com
 */
public class FixFunction extends JBasicFunction {
     ...
     */
    public FixFunction( String name, TokenIterator it ) throws JBasicException {
