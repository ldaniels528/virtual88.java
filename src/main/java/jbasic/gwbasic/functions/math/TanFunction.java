...
/**
 * Represents a Tangent Function
 * @author lawrence.daniels@gmail.com
 */
public class TanFunction extends JBasicFunction {
     ...
     */
    public TanFunction( String name, TokenIterator it ) throws JBasicException {
	...
	public MemoryObject getValue(JBasicCompiledCodeReference program) {
		...
		final NumberMemoryObject decimal = new JBasicTempNumber( Math.tan( angle ) );
		return decimal;
	}
