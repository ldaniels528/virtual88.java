...
public class GwBasicRuntime implements JBasicRuntime {
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.common.program.JBasicCompiler#evaluate(JBasicSourceCode,JBasicProgramStatement)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.common.program.JBasicCompiler#run(JBasicSourceCode)
	 */
