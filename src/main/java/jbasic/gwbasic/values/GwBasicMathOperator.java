...
import jbasic.common.exceptions.IllegalOperatorException;
...
public class GwBasicMathOperator {
	...
	public MemoryObject operate( NumberMemoryObject numberA, NumberMemoryObject numberB ) {
        switch( operatorId ) {
        case MUL: return numberA.multiply( numberB );
        case DIV: return numberA.divide( numberB ); 
        case ADD: return numberA.add( numberB ); 
        case SUB: return numberA.subtract( numberB );
        case POW: return numberA.exponent( numberB ); 
        case MOD: return numberA.modulus( numberB );
        default: 
