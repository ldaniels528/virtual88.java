...
import static jbasic.assembler.instruction.element.registers.X86RegisterReferences.isRegister16G;
import static jbasic.assembler.util.X86CompilerUtil.getConfiguredTokenizer;
import static jbasic.assembler.util.X86CompilerUtil.isNumber;
import static jbasic.assembler.util.X86CompilerUtil.mandateToken;
import static jbasic.assembler.util.X86CompilerUtil.noMoreTokens;
...
import jbasic.assembler.instruction.element.values.X86ByteValue;
import jbasic.assembler.instruction.element.values.X86WordValue;
