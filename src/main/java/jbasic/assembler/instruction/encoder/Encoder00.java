...
import static jbasic.assembler.instruction.encoder.X86AssemblyUtil.generateReferenceCode;
import static jbasic.assembler.instruction.encoder.X86AssemblyUtil.getElementOrder;
...
import jbasic.assembler.instruction.element.registers.X86RegisterReferences;
import jbasic.assembler.instruction.exception.X86InvalidNumberOfParametersException;
...
public class Encoder00 implements InstructionEncoder {
	...
	private static final List<Integer> INSTRUCTION_CODES = 
		Arrays.asList( new Integer[] {
			ADD_CODE_A, OR_CODE_A, ADC_CODE_A, SBB_CODE_A, AND_CODE_A, SUB_CODE_A, XOR_CODE_A, CMP_CODE_A
		} );
