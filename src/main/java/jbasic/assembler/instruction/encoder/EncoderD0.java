...
import static jbasic.assembler.instruction.element.registers.X86RegisterReferences.CL;
import static jbasic.assembler.instruction.element.values.X86ByteValue.ONE;
import static jbasic.assembler.instruction.encoder.X86AssemblyUtil.checkParameterCount;
import static jbasic.assembler.instruction.encoder.X86AssemblyUtil.createInstructionMapping;
...
import jbasic.assembler.instruction.exception.X86InvalidRegisterUsageException;
