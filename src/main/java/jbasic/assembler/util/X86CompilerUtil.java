...
import static jbasic.gwbasic.values.GwBasicValues.isHexadecimalConstant;
import static jbasic.gwbasic.values.GwBasicValues.isIntegerConstant;
import static jbasic.gwbasic.values.GwBasicValues.isOctalConstant;
import static jbasic.gwbasic.values.GwBasicValues.parseHexadecimalString;
import static jbasic.gwbasic.values.GwBasicValues.parseIntegerString;
import ibmpc.exceptions.X86AssemblyException;
import jbasic.assembler.instruction.element.addressing.X86MemoryAddressParser;
...
public class X86CompilerUtil {
	...
	throws X86AssemblyException {
		...
		if( X86MemoryAddressParser.isDirectAddress( identifier ) ) {
			final int offset = parseNumeric( identifier.substring( 1, identifier.length() - 1 ) ); 
			return offset;
		}
