...
public class JBasicDisplayWrapper implements IbmPcDisplay {
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#backspace()
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#clear()
	 */
	public void clear() {
		display.clear();
	}
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#copyPage(int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#drawLine(int, int, int, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#getActivePage()
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#getCharacterAttribute(int)
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#getContext()
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#getCursorPosition()
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#getCursorPosition(int)
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#getDisplayMode()
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#getVideoOffset(int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#init(ibmpc.devices.display.IbmPcDisplayFrame)
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#newLine()
	 */
	public void newLine() {
		display.newLine();
	}
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#readPixel(int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#scroll(int)
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#setActivePage(int)
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#setCharacterAttribute(int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#setColor(ibmpc.devices.display.IbmPcColorSet)
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#setCursorPosition(int, int)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see ibmpc.display.IbmPcVgaColorDisplay#setMode(IbmPcDisplayMode)
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#update()
	 */
	public void update() {
		display.update();
	}
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#write(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#writeLine(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#writePixel(int, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see ibmpc.devices.display.IbmPcDisplay#writeXY(int, int, java.lang.String)
	 */
