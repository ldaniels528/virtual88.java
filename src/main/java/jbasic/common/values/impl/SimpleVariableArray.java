...
public class SimpleVariableArray implements VariableArray {
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.VariableArray#length()
	 */
	public int length() {
		return length;
	}
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.VariableArray#destroy()
	 */
	public void destroy() {
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.VariableArray#getValue(int, jbasic.environment.JBasicEnvironment)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.VariableArray#setValue(int,jbasic.values.types.JBasicObject)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.VariableArray#getElement(int)
	 */
