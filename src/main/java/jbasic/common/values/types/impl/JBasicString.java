...
import jbasic.common.exceptions.StringTooLongException;
...
public class JBasicString extends JBasicObject implements StringMemoryObject {	
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.JBasicString#append(jbasic.values.JBasicObject)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicObject#copy()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.JBasicObject#length()
	 */
	public int length() {
		return getLength();
	}
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.JBasicString#setString(java.lang.String)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.JBasicObject#toDouble()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.JBasicString#toString()
	 */
