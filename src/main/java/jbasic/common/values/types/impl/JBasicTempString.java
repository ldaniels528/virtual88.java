...
public class JBasicTempString implements StringMemoryObject {
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicString#append(jbasic.base.values.types.JBasicObject)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicString#length()
	 */
	public int length() {
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicString#setString(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see jbasic.common.values.types.StringMemoryObject#initialize()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicObject#toDecimal()
	 */
