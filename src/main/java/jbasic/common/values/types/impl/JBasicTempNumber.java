...
public class JBasicTempNumber implements NumberMemoryObject {	
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicObject#getContent()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicObject#setContent(java.lang.Object)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicNumber#setValue(double)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicNumber#add(jbasic.base.values.types.JBasicNumber)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicNumber#divide(jbasic.base.values.types.JBasicNumber)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicNumber#exponent(jbasic.base.values.types.JBasicNumber)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicNumber#modulus(jbasic.base.values.types.JBasicNumber)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicNumber#multiply(jbasic.base.values.types.JBasicNumber)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicNumber#subtract(jbasic.base.values.types.JBasicNumber)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicObject#duplicate()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicObject#getOffset()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicObject#getSegment()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicObject#isCompatibleWith(jbasic.base.values.types.JBasicObject)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicObject#isNumeric()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicObject#isString()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicObject#size()
	 */
	public int size() {
	...
	/* 
	 * (non-Javadoc)
	 * @see ibmpc.program.values.types.IbmPcObject#toDoublePrecision()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.base.values.types.JBasicObject#toInteger()
	 */
