...
implements MsDosDisketteFileControlBlock {
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#getBuffer()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#setBuffer(byte[])
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicObject#setContent(java.lang.Object)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#getDevice()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#setDevice(int)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#getDisketteControlBlock()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#setDisketteControlBlock(byte[])
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#getFlags()
	 */
	public int getFlags() {
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#setFlags(int)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#getLogicalRecordNumber()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#setLogicalRecordNumber(int)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#getMode()
	 */
	public int getMode() {
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#setMode(int)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#getPhysicalRecordNumber()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#setPhysicalRecordNumber(int)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#getPosition()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#setPosition(int)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#getWidth()
	 */
	public int getWidth() {
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#setWidth(int)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#getVariableRecordLength()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicFileControlBlock#setVariableRecordLength(int)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicObject#isCompatibleWith(jbasic.values.types.JBasicObject)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicObject#isNumeric()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicObject#isString()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicObject#size()
	 */
	public int size() {
		return LENGTH;
	}
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicObject#toDoublePrecision()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see jbasic.values.types.JBasicObject#toInteger()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see ibmpc.program.values.types.IbmPcObject#toSinglePrecision()
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see ibmpc.program.values.types.IbmPcObject#toString()
	 */
