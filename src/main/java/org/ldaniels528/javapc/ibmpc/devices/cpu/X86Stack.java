...
import org.ldaniels528.javapc.ibmpc.exceptions.X86StackException;
...
public class X86Stack implements Operand {
    ...
    /* (non-Javadoc)
     * @see org.ldaniels528.javapc.ibmpc.devices.cpu.operands.Operand#get()
     */
    public int get() {
        return popValue();
    }
    ...
    /* (non-Javadoc)
     * @see org.ldaniels528.javapc.ibmpc.devices.cpu.operands.Operand#set(int)
     */
    ...
    /* (non-Javadoc)
     * @see org.ldaniels528.javapc.ibmpc.devices.cpu.operands.Operand#size()
     */
    public int size() {
        return SIZE_16BIT;
    }
     ...
     * @throws X86StackException
     */
    public int peek(int element) throws X86StackException {
        // there must be an element in the stack
        if (elements == 0) {
            return -1;
        }
     ...
     * @throws X86StackException
     */
    public void pop(final Operand operand) throws X86StackException {
