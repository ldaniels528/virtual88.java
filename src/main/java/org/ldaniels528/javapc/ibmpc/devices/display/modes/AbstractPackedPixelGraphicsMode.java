...
public abstract class AbstractPackedPixelGraphicsMode extends AbstractGraphicsMode {
	...
	/* 
	 * (non-Javadoc)
	 * @see org.ldaniels528.javapc.ibmpc.display.modes.AbstractDisplayMode#scroll(org.ldaniels528.javapc.ibmpc.display.IbmPcDisplayContext, int)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see org.ldaniels528.javapc.ibmpc.display.modes.AbstractDisplayMode#writeCharacter(org.ldaniels528.javapc.ibmpc.display.IbmPcDisplayContext, int, int, char)
	 */
