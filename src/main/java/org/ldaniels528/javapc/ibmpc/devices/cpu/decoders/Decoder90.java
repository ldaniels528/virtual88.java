...
import org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.bitwise.NOP;
import org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.data.CBW;
import org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.data.CWD;
import org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.data.XCHG;
import org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.flags.LAHF;
import org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.flags.SAHF;
import org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.flow.callret.CALL;
import org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.stack.POPF;
import org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.stack.PUSHF;
import org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.system.WAIT;
...
public class Decoder90 implements Decoder {
    ...
    public OpCode decode(final I8086 cpu, final X86MemoryProxy proxy, DecodeProcessor processor) {
        ...
        switch (code8) {
            ...
            // CALL offset, segment
            case 0x9A:
                return new CALL(DecoderUtil.nextAddressFar(cpu, proxy));
            // WAIT
            case 0x9B:
