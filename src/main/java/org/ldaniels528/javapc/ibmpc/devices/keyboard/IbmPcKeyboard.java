...
public class IbmPcKeyboard implements KeyListener, IbmPcKeyConstants {
     ...
     */
    public String next(final int maxChars) throws InterruptedException {
     ...
     * @return the next line of input
     */
    public String nextLine(final String initialText) throws InterruptedException {
     ...
     * @return the next line of input
     */
    public String nextLine(final String initialText, final int maxChars) throws InterruptedException {
        // start taking in input
        synchronized (buffer) {
            // set things up
            complete = false;
    ...
    public void keyTyped(final KeyEvent event) {
        ...
        switch (keyChar) {
            ...
            case KeyEvent.VK_ENTER:
                ...
                break;
            default:
                printCharacter(event.getKeyChar());
        }
    }
