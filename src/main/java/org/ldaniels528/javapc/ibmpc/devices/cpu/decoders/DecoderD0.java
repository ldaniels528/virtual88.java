...
import org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.bitwise.*;
import org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.data.DB;
import org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.data.DW;
import org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.data.ESC;
import org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.data.XLAT;
import org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.math.AAD;
import org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.math.AAM;
...
import static org.ldaniels528.javapc.ibmpc.devices.cpu.opcodes.data.ESC.*;
...
public class DecoderD0 implements Decoder {
    ...
    private OpCode decodeTypeA(final I8086 cpu, final X86MemoryProxy proxy, final int code8) {
        ...
        final Operand dest = DecoderUtil.lookupSecondaryOperand(cpu, proxy, code16);
