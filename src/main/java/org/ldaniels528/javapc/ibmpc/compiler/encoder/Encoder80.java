...
import static org.ldaniels528.javapc.ibmpc.compiler.element.registers.X86RegisterReferences.AL;
import static org.ldaniels528.javapc.ibmpc.compiler.element.registers.X86RegisterReferences.AX;
import static org.ldaniels528.javapc.ibmpc.compiler.encoder.X86AssemblyUtil.checkParameterCount;
import static org.ldaniels528.javapc.ibmpc.compiler.encoder.X86AssemblyUtil.is8Bit;
import static org.ldaniels528.javapc.ibmpc.compiler.encoder.X86AssemblyUtil.isGeneralPurposeRegister;
...
public class Encoder80 implements InstructionEncoder {
	...
	/* (non-Javadoc)
	 * @see org.ldaniels528.javapc.ibmpc.app.compiler.instruction.encoder.InstructionEncoder#encode(org.ldaniels528.javapc.ibmpc.app.compiler.instruction.X86CodeBuffer, org.ldaniels528.javapc.ibmpc.app.compiler.instruction.X86Instruction)
	 */
