    ...
    public void process(final IbmPcSystem system, final Intel80x86 cpu) throws X86AssemblyException {
        ...
        switch (cpu.AX.get()) {
            ...
            case 0x02:
                ...
                break;
            case 0x03:
                getPositionAndButtonStatus(mouse, cpu);
                break;
            case 0x04:
                setPosition(mouse, cpu);
                break;
            case 0x05:
                getButtonPressInfo(mouse, cpu);
                break;
            case 0x06:
                getButtonReleseInfo(mouse, cpu);
                break;
            case 0x07:
                setHorizontalMinOrMax(mouse, cpu);
                break;
            case 0x08:
                setVerticalMinOrMax(mouse, cpu);
                break;
            case 0x09:
                setGraphicsCursor(mouse, cpu);
                break;
            case 0x0A:
                setTextCursor(mouse, cpu);
                break;
            case 0x0B:
                readMotionCounters(mouse, cpu);
                break;
            case 0x0C:
                setUserDefinedInputMask(mouse, cpu);
                break;
            case 0x0D:
                setMouseLightPenEmulationOn(mouse, cpu);
                break;
            case 0x0E:
                setMouseLightPenEmulationOff(mouse, cpu);
                break;
            case 0x0F:
                setMousePixelRatio(mouse, cpu);
                break;
            case 0x10:
                setMouseConditionOff(mouse, cpu);
                break;
            case 0x13:
                setMouseDoubleSpeedThresthold(mouse, cpu);
                break;
            case 0x14:
                swapInterruptSubroutine(mouse, cpu);
                break;
            case 0x15:
                getDriverStateAndRequirements(mouse, cpu);
                break;
            case 0x16:
                saveDriverState(mouse, cpu);
                break;
            case 0x17:
                restoreDriverState(mouse, cpu);
                break;
            case 0x18:
                setAlternateSubroutineCallMaskAndAddress(mouse, cpu);
                break;
            case 0x19:
                getAlternateInterruptAddress(mouse, cpu);
                break;
            case 0x1A:
                setSensitivity(mouse, cpu);
                break;
            case 0x1B:
                getSensitivity(mouse, cpu);
                break;
            case 0x1C:
                setInterruptRate(mouse, cpu);
                break;
            case 0x1D:
                setCrtPage(mouse, cpu);
                break;
            case 0x1E:
                getCrtPage(mouse, cpu);
                break;
            case 0x1F:
                disableDriver(mouse, cpu);
                break;
            case 0x20:
                enableDriver(mouse, cpu);
                break;
            case 0x21:
                resetSoftware(mouse, cpu);
                break;
            case 0x22:
                setLanguageForMessages(mouse, cpu);
                break;
            case 0x23:
                getLanguageNumber(mouse, cpu);
                break;
            case 0x24:
                getDriverVersionMouseTypeAndIRQ(mouse, cpu);
                break;
            default:
