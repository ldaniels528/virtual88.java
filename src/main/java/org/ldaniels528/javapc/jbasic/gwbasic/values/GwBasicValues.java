...
import org.ldaniels528.javapc.jbasic.common.values.impl.SimpleVariableArrayIndexReference;
...
import org.ldaniels528.javapc.jbasic.gwbasic.functions.GwBasicFunctionManager;
...
public class GwBasicValues extends Values {
     ...
     * @return a {@link org.ldaniels528.javapc.jbasic.common.values.VariableReference reference to the variable}
     * @throws org.ldaniels528.javapc.jbasic.common.exceptions.JBasicException
     */
    public static SimpleConstant getConstantValue(TokenIterator it) throws JBasicException {
        // get the value
     ...
     * @throws org.ldaniels528.javapc.jbasic.common.exceptions.JBasicException
     */
    public static Value getValue(TokenIterator it) throws JBasicException {
        ...
        // if the next token is a '(', then it may be a variable array
            ...
            return new SimpleVariableArrayIndexReference(token, index);
        }
     ...
     *
     * @param it the given {@link TokenIterator iterator}
     * @return a {@link Value reference to the value}
     * @throws JBasicException
     */
    public static Value getValueReference(TokenIterator it) throws JBasicException {
     ...
     * @return a {@link VariableReference reference} to the variable
     * @throws JBasicException
     */
    public static VariableReference getVariableReference(TokenIterator it) throws JBasicException {
        // get a value
     ...
     */
    public static NumberMemoryObject parseNumber(String number) throws JBasicException {
        // is it an integer constant?
        if (isIntegerConstant(number)) {
            final int value = parseIntegerString(number);
            return new JBasicTempNumber(value);
        }
     ...
     */
    public static double parseDecimalString(String decString) throws IllegalNumberFormat {
        try {
     ...
     * @throws IllegalNumberFormat
     */
    public static int parseHexadecimalString(String hexString) throws IllegalNumberFormat {
     ...
     *
     * @param octalString the given octal string
     * @return the integer equivalent value
     * @throws IllegalNumberFormat
     */
     ...
     *
     * @param numString the given numeric string
     * @return the decimal equivalent value
     * @throws IllegalNumberFormat
     */
    ...
    public static int toUnsignedInteger(int number) {
        return (number < 1) ? number + 0x10000 : number;
    }
