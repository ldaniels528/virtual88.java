...
public interface JBasicCompiledCode extends JBasicCompiledCodeReference {
    ...
    /**
     * Returns the GWBASIC/BASICA environment
     *
     * @return the {@link GwBasicEnvironment environment}
     */
    GwBasicEnvironment getEnvironment();
     ...
     *
     * @param constant the given {@link org.ldaniels528.javapc.jbasic.common.values.impl.SimpleConstant constant value}
     */
     ...
     *
     * @param arrayName the name of the referenced array
     * @param arraySize the size of the array
     */
    void createArrayVariable(String arrayName, int arraySize) throws OutOfMemoryException;
     ...
     *
     * @param variable the given {@link org.ldaniels528.javapc.jbasic.common.values.Variable variable}
     */
     ...
     */
    void conditionalControlIterate(JBasicCompiledCode program, Variable variable) throws JBasicException;
