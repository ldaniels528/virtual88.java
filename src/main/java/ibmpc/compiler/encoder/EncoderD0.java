...
import static ibmpc.compiler.element.registers.X86RegisterReferences.CL;
import static ibmpc.compiler.element.values.X86ByteValue.ONE;
import static ibmpc.compiler.encoder.X86AssemblyUtil.checkParameterCount;
import static ibmpc.compiler.encoder.X86AssemblyUtil.createInstructionMapping;
import static ibmpc.compiler.encoder.X86AssemblyUtil.is8Bit;
import static ibmpc.compiler.encoder.X86AssemblyUtil.isGeneralPurposeRegister;
...
import ibmpc.compiler.exception.X86InvalidRegisterUsageException;
