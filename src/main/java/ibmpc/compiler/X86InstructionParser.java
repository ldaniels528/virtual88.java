...
import static ibmpc.compiler.element.addressing.X86ReferencedAddressParser.isReference;
import static ibmpc.compiler.element.addressing.X86ReferencedAddressParser.parseReference;
import static ibmpc.compiler.element.registers.X86RegisterReferences.isRegister;
import static ibmpc.compiler.element.registers.X86RegisterReferences.lookupRegister;
import static ibmpc.compiler.element.values.X86Value.*;
