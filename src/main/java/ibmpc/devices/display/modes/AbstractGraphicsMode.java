...
public abstract class AbstractGraphicsMode extends AbstractDisplayMode {
	...
	/* 
	 * (non-Javadoc)
	 * @see ibmpc.display.modes.IbmPcDisplayMode#backspace(ibmpc.display.IbmPcDisplayContext)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see ibmpc.display.modes.IbmPcDisplayMode#clear(ibmpc.display.IbmPcDisplayContext)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see ibmpc.display.modes.IbmPcDisplayMode#drawLine(ibmpc.display.IbmPcDisplayContext, int, int, int, int)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see ibmpc.display.modes.IbmPcDisplayMode#getCursorPosition(ibmpc.display.IbmPcDisplayContext, int, int)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see ibmpc.display.modes.IbmPcDisplayMode#newLine(ibmpc.display.IbmPcDisplayContext)
	 */
	...
	/* 
	 * (non-Javadoc)
	 * @see ibmpc.display.modes.IbmPcDisplayMode#writeText(ibmpc.display.IbmPcDisplayContext, int, java.lang.String)
	 */
