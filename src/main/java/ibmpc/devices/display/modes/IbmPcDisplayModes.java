...
import ibmpc.devices.display.modes.cga.CGAGraphicsMode160x200PCjr;
import ibmpc.devices.display.modes.cga.CGAGraphicsMode320x200;
import ibmpc.devices.display.modes.cga.CGAGraphicsMode320x200PCjr;
import ibmpc.devices.display.modes.cga.CGAGraphicsMode640x200Mono;
import ibmpc.devices.display.modes.cga.CGAGraphicsMode640x200PCjr;
import ibmpc.devices.display.modes.cga.CGATextMode40x25;
import ibmpc.devices.display.modes.cga.CGATextMode80x25;
import ibmpc.devices.display.modes.ega.EGAGraphicsMode320x200;
import ibmpc.devices.display.modes.ega.EGAGraphicsMode640x200;
import ibmpc.devices.display.modes.ega.EGAGraphicsMode640x350;
import ibmpc.devices.display.modes.ega.EGAGraphicsMode640x350Mono;
import ibmpc.devices.display.modes.mda.MDATextMode720x350;
import ibmpc.devices.display.modes.vga.VGAGraphicsMode320x200;
import ibmpc.devices.display.modes.vga.VGAGraphicsMode640x480;
import ibmpc.devices.display.modes.vga.VGAGraphicsMode640x480Mono;
