...
/**
 * Represents the set of 8x8 and 8x16 fonts available for BASIC/GWBASIC variants
 * <pre>
 * 10000000 | 01111111
 * 01000000 | 10111111
 * 00100000 | 11011111
 ...
 */
public class IbmPcFont8x8 implements IbmPcFont {
	public static final int[] PIXEL_ON_MASK = { 0x80, 0x40, 0x20, 0x10, 0x08, 0x04, 0x02, 0x01 };
	public static final int[] PIXEL_ZERO_MASK = { 0x7F, 0xBF, 0xDF, 0xEF, 0xF7, 0xFB, 0xFD, 0xFE };
	public static final byte[] FONTS_8X8 = get8x8FontData();
	private static final IbmPcFont8x8 instance = new IbmPcFont8x8();
	...
	/* 
	 * (non-Javadoc)
	 * @see ibmpc.display.fonts.IbmPcFont#getData(int)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ibmpc.display.fonts.IbmPcFont#getWidth()
	 */
	public int getWidth() {
		return WIDTH;
	}
	...
	/* 
	 * (non-Javadoc)
	 * @see ibmpc.display.fonts.IbmPcFont#getHeight()
	 */
	...
	/**
	 * Generates CGA/EGA 8x8 Fonts
	 */
	private static final byte[] get8x8FontData() {
		final short[] FONT_BYTES = {
		...
		final byte[] fonts = new byte[ FONT_BYTES.length ];
		for( int n = 0; n < FONT_BYTES.length; n++ ) {
			fonts[n] = (byte)FONT_BYTES[n];
		}
		return fonts;                               
	}
