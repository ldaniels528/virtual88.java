...
import ibmpc.devices.cpu.x86.opcodes.string.*;
import ibmpc.devices.memory.X86MemoryProxy;

import static ibmpc.devices.cpu.x86.decoder.DecoderUtil.nextAddressByte;
import static ibmpc.devices.cpu.x86.decoder.DecoderUtil.nextAddressWord;
