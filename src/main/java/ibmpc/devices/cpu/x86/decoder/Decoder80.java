...
import static ibmpc.devices.cpu.x86.decoder.DecoderUtil.nextSignedValue8;
...
import ibmpc.devices.cpu.x86.opcodes.addressing.LEA;
import ibmpc.devices.cpu.x86.opcodes.bitwise.AND;
import ibmpc.devices.cpu.x86.opcodes.bitwise.OR;
import ibmpc.devices.cpu.x86.opcodes.bitwise.XOR;
import ibmpc.devices.cpu.x86.opcodes.data.MOV;
import ibmpc.devices.cpu.x86.opcodes.data.XCHG;
import ibmpc.devices.cpu.x86.opcodes.math.ADC;
import ibmpc.devices.cpu.x86.opcodes.math.ADD;
import ibmpc.devices.cpu.x86.opcodes.math.CMP;
import ibmpc.devices.cpu.x86.opcodes.math.SBB;
...
public class Decoder80 implements Decoder {
	 ...
	 */
	private OpCode decodeTypeA( final Intel80x86 cpu, final X86MemoryProxy proxy, final int code16 ) {
	 ...
	 * @return an {@link OpCode 80x86 opCode}  
	 */
	private OpCode decodeTypeB( final Intel80x86 cpu, final X86MemoryProxy proxy, final int code16 ) {
		// instruction code layout
		// -----------------------------
		// fedc ba98 7654 3210 (16 bits)
		// ttrr rmmm iiii iijc 
	 ...
	 * @return an {@link OpCode 80x86 opCode}  
	 */
	private OpCode decodeTypeC( final Intel80x86 cpu, final X86MemoryProxy proxy, final int code16 ) {
		// instruction code layout
		// -----------------------------
		// fedc ba98 7654 3210 (16 bits)
		// ttrr rmmm iiii iisc 
	 ...
	 * @return an {@link OpCode 80x86 opCode}  
	 */
	private OpCode decodeTypeD( final Intel80x86 cpu, final X86MemoryProxy proxy, final int code16 ) {
		// instruction code layout
		// -----------------------------
		// fedc ba98 7654 3210 (16 bits)
		// ttrr rmmm iiii iijj 
	 ...
	 */
	private LEA decodeLEA( final Intel80x86 cpu, final X86MemoryProxy proxy, final int code16 ) {
	 ...
	 */
	private MOV decodeMOV( final Intel80x86 cpu, final X86MemoryProxy proxy, final int code16 ) {
	 ...
	 */
	private POP decodePOP( final Intel80x86 cpu, final X86MemoryProxy proxy, final int code16 ) {
