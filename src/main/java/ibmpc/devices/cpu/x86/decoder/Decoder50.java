...
public class Decoder50 implements Decoder {
	...
	public OpCode decode( final Intel80x86 cpu, X86MemoryProxy proxy ) {
		...
		switch( code8 ) {
			// PUSH codes
			case 0x50: return new PUSH( cpu.AX ); 
			case 0x51: return new PUSH( cpu.CX ); 
			case 0x52: return new PUSH( cpu.DX ); 
			case 0x53: return new PUSH( cpu.BX ); 
			case 0x54: return new PUSH( cpu.SP ); 
			case 0x55: return new PUSH( cpu.BP ); 
			case 0x56: return new PUSH( cpu.SI ); 
			case 0x57: return new PUSH( cpu.DI ); 
			
			// POP codes
			case 0x58: return new POP( cpu.AX ); 
			case 0x59: return new POP( cpu.CX ); 
			case 0x5A: return new POP( cpu.DX ); 
			case 0x5B: return new POP( cpu.BX ); 
			case 0x5C: return new POP( cpu.SP ); 
			case 0x5D: return new POP( cpu.BP ); 
			case 0x5E: return new POP( cpu.SI ); 
			case 0x5F: return new POP( cpu.DI ); 
