...
public class VideoServices implements InterruptHandler {
	...
	throws X86AssemblyException {
		...
		switch( cpu.AH.get() ) {
			case 0x00: setVideoMode( display, cpu ); break;
			case 0x01: setCursorSizeAndShape( display, cpu ); break;
			case 0x02: setCursorPosition( display, cpu ); break;
			case 0x03: queryCursorPositionAndSize( display, cpu ); break;
			case 0x04: readLightPen( display, cpu ); break;
			case 0x05: setActiveDisplayPage( display, cpu ); break;
			case 0x06: scrollWindowUp( display, cpu ); break;
			case 0x07: scrollWindowDown( display, cpu ); break;
			case 0x08: readCharacterOrAttribute( display, cpu ); break;
			case 0x09: writeCharacterOrAttribute( display, cpu ); break;
			case 0x0A: writeCharacterAsTTY( display, cpu ); break;
			case 0x0B: setColorPaletteOrBorder( display, cpu ); break;
			case 0x0C: writeGraphicsPixel( display, cpu ); break;
			case 0x0D: readGraphicsPixel( display, cpu ); break;
			case 0x0E: writeCharacterAsTTY( display, cpu ); break;
			case 0x0F: readVideoMode( display, cpu ); break;
			default:
	 ...
	 * @throws X86AssemblyException
	 */
	private void setVideoMode( final IbmPcDisplay display, final Intel80x86 cpu ) 
	throws X86AssemblyException {
	 ...
	 * @throws X86AssemblyException 
	 */
	private void queryCursorPositionAndSize( final IbmPcDisplay display, final Intel80x86 cpu ) 
	throws X86AssemblyException {
	 ...
	 * @throws X86AssemblyException 
	 */
	private void readLightPen( final IbmPcDisplay display, final Intel80x86 cpu ) 
	throws X86AssemblyException {
		throw new X86AssemblyException( "Not yet implemeneted" );
	}
	 ...
	 * @throws X86AssemblyException
	 */
	private void setActiveDisplayPage( final IbmPcDisplay display, final Intel80x86 cpu ) 
	throws X86AssemblyException {
	 ...
	 * @throws X86AssemblyException
	 */
	private void scrollWindowUp( final IbmPcDisplay display, final Intel80x86 cpu ) 
	throws X86AssemblyException {
	 ...
	 * @throws X86AssemblyException
	 */
	private void scrollWindowDown( final IbmPcDisplay display, final Intel80x86 cpu ) 
	throws X86AssemblyException {
		// number of lines to scroll in (0=blank entire rectangle)
		final int nLines 	= cpu.AL.get();
	 ...
	 * @throws X86AssemblyException
	 */
	private void readCharacterOrAttribute( final IbmPcDisplay display, final Intel80x86 cpu ) 
	throws X86AssemblyException {	
		// get display page
		final int page = cpu.BH.get();
	 ...
	 * @throws X86AssemblyException
	 */
	private void writeCharacterOrAttribute( final IbmPcDisplay display, final Intel80x86 cpu ) 
	throws X86AssemblyException {
	 ...
	 * @throws X86AssemblyException
	 */
	private void writeCharacterAsTTY( final IbmPcDisplay display, final Intel80x86 cpu ) 
	throws X86AssemblyException {
	 ...
	 * @throws X86AssemblyException
	 */
	private void setColorPaletteOrBorder( final IbmPcDisplay display, final Intel80x86 cpu ) 
	throws X86AssemblyException {
		// get the parameters
		...
		switch( mode ) {
			// set border color?
			case 0: display.setColor( new IbmPcColorSet( -1, -1, color ) ); break;
					
			// set palette?
			case 1: display.setColor( new IbmPcColorSet( -1, -1, color ) ); break;
	 ...
	 * @throws X86AssemblyException
	 */
	private void writeGraphicsPixel( final IbmPcDisplay display, final Intel80x86 cpu ) 
	throws X86AssemblyException {
	 ...
	 * @throws X86AssemblyException
	 */
	private void readGraphicsPixel( final IbmPcDisplay display, final Intel80x86 cpu ) 
	throws X86AssemblyException {
		// get input parameters
		final int column = cpu.CX.get(); // 0..319/639
		final int row	= cpu.DX.get(); // 0..199/479
	 ...
	 * @throws X86AssemblyException
	 */
	private void readVideoMode( final IbmPcDisplay display, final Intel80x86 cpu ) 
	throws X86AssemblyException {
		// get the display mode
		final IbmPcDisplayMode mode = display.getDisplayMode();
